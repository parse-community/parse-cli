...
func (c *configureCmd) processHooksOperation(e *parsecli.Env, op string) ([]string, error) {
...
func (c *configureCmd) functionHookExists(e *parsecli.Env, name string) (bool, error) {
...
func (c *configureCmd) deployFunctionHook(e *parsecli.Env, op *hookOperation) error {
	if op.function == nil {
...
func (c *configureCmd) triggerHookExists(e *parsecli.Env, className, triggerName string) (bool, error) {
...
func (c *configureCmd) deployTriggerHook(e *parsecli.Env, op *hookOperation) error {
	if op.trigger == nil {
...
func (c *configureCmd) deployWebhooksConfig(e *parsecli.Env, hooksOps []*hookOperation) error {
...
func (c *configureCmd) parseBaseURL(e *parsecli.Env) error {
	if c.baseURL != "" {
...
func (c *configureCmd) hooksCmd(e *parsecli.Env, ctx *parsecli.Context, args []string) error {
	if len(args) > 1 {
...
`,
		Run:     parsecli.RunWithArgsClient(e, c.hooksCmd),
