...
func (d *developCmd) contDeploy(e *env, deployer deployFunc, first, done chan struct{}) {
...
func (d *developCmd) handleError(e *env, err error, sleep func(time.Duration)) error {
	if err == nil {
		return nil
	}
...
func newDevelopCmd(e *env) *cobra.Command {
