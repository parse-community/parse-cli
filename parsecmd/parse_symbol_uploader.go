...
func uploadSymbolFiles(files []string, commonHeaders map[string]string, removeFiles bool, e *parsecli.Env) error {
	var wg errgroup.Group
	uploadFile := func(filename string, e *parsecli.Env) {
		defer wg.Done()
