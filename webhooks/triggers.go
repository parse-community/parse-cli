...
func readTriggerName(e *parsecli.Env, params *triggerHook) (*triggerHook, error) {
...
func readTriggerParams(e *parsecli.Env, params *triggerHook) (*triggerHook, error) {
...
func (h *triggerHooksCmd) triggerHooksCreate(e *parsecli.Env, ctx *parsecli.Context) error {
...
func (h *triggerHooksCmd) triggerHooksRead(e *parsecli.Env, ctx *parsecli.Context) error {
...
func (h *triggerHooksCmd) triggerHooksUpdate(e *parsecli.Env, ctx *parsecli.Context) error {
	params, err := readTriggerParams(e, h.Trigger)
	if err != nil {
		return err
	}
...
func (h *triggerHooksCmd) triggerHooksDelete(e *parsecli.Env, ctx *parsecli.Context) error {
...
func (h *triggerHooksCmd) triggerHooks(e *parsecli.Env, c *parsecli.Context) error {
	hp := *h
	hp.All = true
	return hp.triggerHooksRead(e, c)
}

func NewTriggerHooksCmd(e *parsecli.Env) *cobra.Command {
	...
	createCmd := &cobra.Command{
		...
		Run:   parsecli.RunWithClient(e, h.triggerHooksCreate),
	}
	...
	changeCmd := &cobra.Command{
		...
		Run:   parsecli.RunWithClient(e, h.triggerHooksUpdate),
	}
	...
	deleteCmd := &cobra.Command{
		...
		Run:   parsecli.RunWithClient(e, h.triggerHooksDelete),
	}
